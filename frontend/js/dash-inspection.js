...
var DashInspection = (function () {
  ...
  var filterFrom = document.getElementById('inspFilterFrom');
  var filterTo = document.getElementById('inspFilterTo');
